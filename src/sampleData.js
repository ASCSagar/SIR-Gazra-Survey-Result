...
const sampleData = [
  {
    ...
    "In your opinion, how common is physical violence against women in your community?":
      "Very common",
    "Which form of physical violence do you think is most prevalent?":
      "Hitting or punching",
    ...
    "Which form of emotional/psychological abuse do you think is most common?":
      "Gaslighting",
    "How easy do you think it is for victims to recognize emotional/psychological abuse?":
      "Somewhat difficult",
    "Before this survey, were you aware of the concept of economic abuse?":
      "I had heard of it but didn't know much about it",
    "Which form of economic abuse do you think has the most long-term impact?":
      "Controlling all finances",
    "How serious do you think the issue of stalking is in your community?":
      "Very serious",
    "Which form of stalking or harassment do you think is most common?":
      "Unwanted, persistent communication",
    "Do you think current laws adequately address stalking and harassment?":
      "No",
    "How prevalent do you think cyber violence is against women?":
      "Very prevalent",
    "Which form of cyber violence do you think is most harmful?":
      "Online harassment or bullying",
    "Do you think law enforcement is well-equipped to handle cases of cyber violence?":
      "No",
    ...
    "Are you aware of any local resources or organizations that support women experiencing violence?":
      "Yes",
    "What do you think is the most effective way to prevent violence against women?":
...
const locations = ["Urban", "Sami-urban", "Rural"];
...
for (let i = 0; i < 49; i++) {
  sampleData.push({
    ...
    gender: getRandomElement(occupations),
    location: getRandomElement(locations),
    'Are you familiar with the term "violence against women"?':
      getRandomElement(familiarityOptions),
    "Have you ever witnessed or experienced any form of violence against women?":
      getRandomElement(yesNoOptions),
    "Which of the following do you consider to be forms of violence against women?":
      formsOfViolence.filter(() => Math.random() < 0.3),
    "Before this survey, were you aware that all of these actions could be considered forms of violence against women?":
      getRandomElement(awarenessOptions),
    "In your opinion, how common is physical violence against women in your community?":
      getRandomElement(commonalityOptions),
    "Which form of physical violence do you think is most prevalent?":
      getRandomElement(physicalViolenceForms),
    "Where do you think physical violence against women most commonly occurs?":
      getRandomElement(locationsOfViolence),
    "How would you rate the prevalence of sexual violence against women in your community?":
      getRandomElement(prevalenceOptions),
    "Which form of sexual violence do you think is most underreported?":
      getRandomElement(sexualViolenceForms),
    "In your opinion, what is the biggest barrier to reporting sexual violence?":
      getRandomElement(barriersToReporting),
    "Do you think emotional/psychological abuse is taken as seriously as physical violence?":
      getRandomElement(emotionalAbuseOptions),
    "Which form of emotional/psychological abuse do you think is most common?":
      getRandomElement(emotionalAbuseForms),
    "How easy do you think it is for victims to recognize emotional/psychological abuse?":
      getRandomElement(easeOfRecognition),
    "Before this survey, were you aware of the concept of economic abuse?":
      getRandomElement(economicAbuseAwareness),
    "Which form of economic abuse do you think has the most long-term impact?":
      getRandomElement(economicAbuseForms),
    "How serious do you think the issue of stalking is in your community?":
      getRandomElement(seriousnessOptions),
    "Which form of stalking or harassment do you think is most common?":
      getRandomElement(stalkingForms),
    "Do you think current laws adequately address stalking and harassment?":
      getRandomElement(lawEnforcementOptions),
    "How prevalent do you think cyber violence is against women?":
      getRandomElement(cyberViolencePrevalence),
    "Which form of cyber violence do you think is most harmful?":
      getRandomElement(cyberViolenceForms),
    "Do you think law enforcement is well-equipped to handle cases of cyber violence?":
      getRandomElement(lawEnforcementOptions),
    "Are you aware of any cultural or traditional practices in your community that could be considered forms of violence against women?":
    ...
    "How confident do you feel in your ability to recognize signs of violence against women?":
      getRandomElement(confidenceLevels),
    "If you witnessed violence against a woman, what would you most likely do?":
      getRandomElement(actionsIfWitnessed),
    "Are you aware of any local resources or organizations that support women experiencing violence?":
      getRandomElement(awarenessOfResources),
    "What do you think is the most effective way to prevent violence against women?":
      getRandomElement(preventionMethods),
    "Have you ever participated in any initiatives or programs aimed at preventing violence against women?":
      getRandomElement(participationOptions),
  });
}
